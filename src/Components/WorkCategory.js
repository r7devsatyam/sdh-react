...
import WorkCategoryComponent from "./WorkCategoryComponent";
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              <div className="work-card-set">
                ...
                />
                <WorkCategoryComponent key={"Card-4"} name="Video Service" />
                <WorkCategoryComponent key={"Card-5"} name="Banking Service" />
                <WorkCategoryComponent
                  key={"Card-6"}
                ...
                />
                <WorkCategoryComponent key={"Card-8"} name="Tour and Travels" />
                <WorkCategoryComponent key={"Card-9"} name="Health Service" />
                <WorkCategoryComponent
                  key={"Card-10"}
