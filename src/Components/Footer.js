            ...
            <div className="row justify-content-between">
              ...
              <div className="col-lg-2 col-sm-6">
                ...
                <ul className="footer-address-list link-hover">
                  ...
                  <li>
                    <a href="dangerouslySetInnerHTML">Customer's FAQ</a>
                  </li>
                  <li>
                    <a href="dangerouslySetInnerHTML">Refund Policy</a>
                  </li>
                  <li>
                    <a href="dangerouslySetInnerHTML">Privacy Policy</a>
                  </li>
                  <li>
                    <a href="dangerouslySetInnerHTML">Terms and Conditions</a>
                  </li>
                  <li>
                    <a href="dangerouslySetInnerHTML">License & Copyright</a>
                  </li>
                </ul>
              </div>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="footer-social-media-icons">
                    <a href="dangerouslySetInnerHTML" target="blank">
                  ...
                  <div className="footer-">
                    <p>
                      Copyright &copy; 2020 Niwax. All rights reserved. Template
                      By{" "}
                      <a
